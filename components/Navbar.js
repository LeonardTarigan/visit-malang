...
function Navbar() {
    ...
    return (
        <>
            <Drawer />
            <nav
                className={`sticky top-0 z-20 mb-10 flex items-center justify-between gap-10 py-5 px-5 transition-all duration-200 lg:px-20 ${
            ...
            >
                ...
                {/* navigation */}
                <ul className='hidden select-none gap-10 lg:flex'>
